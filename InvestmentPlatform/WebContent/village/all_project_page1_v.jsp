        ...
        <div class="cztable">
            <table width="700px" border="0" cellspacing="0" cellpadding="0" style="text-align:center;">
                ...
                for(int i = 0; i < 5; i++) {
                    ...
                    <td>
                        <a href=<%="project_demoA_v.jsp?i="+Integer.toString(i)+"&username="+username+"&project=all" %>>
                            <button>点击查看</button>
                        </a>
                    </td>
                </tr>
            ...
            <div class="MainStyle">
                ...
                <div class="">
                	...
                	if(Integer.parseInt(pageNo) == 1) {
                		%>
                		<a href=<%="all_project_page1_v.jsp?pageNo=" + pageNo + "&maxPage=" + Integer.toString(maxPage)%> 
                			target="_self">上一页</a>
                		<%
                	} else {
                		%>
